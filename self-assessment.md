...
| SBOM | The SBOM file has been generated using SPDX, [bom-go-mod.spdx](https://github.com/Brandonpinos/SecurityPals-Operator-Framework/blob/main/bom-go-mod.spdx). The project (or the sub-projects) do not mantain an SBOM. |
| | |
